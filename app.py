...
class BusquedaTabu:
    def __init__(self, coord, ciudad_origen=None, ciudad_destino=None):
        self.coord = coord
    ...
    def ejecutar(self):
        iteraciones_restantes = 100  # Número fijo de iteraciones
        while iteraciones_restantes > 0:
            ...
            for vecino in vecinos:
                ...
                # Si el vecino mejora la solución actual
